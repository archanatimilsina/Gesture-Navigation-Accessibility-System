...
// import DollarNRecognizer from '../js/DollarNRecognizer';
import {DollarOneRecognizer} from '../js/DollarOneRecognizer';
// import DollarPPlusRecognizer from '../js/DollarPPlusRecognizer';
// import DollarPRecognizer from '../js/DollarPRecognizer';
// import DollarQRecognizer from '../js/DollarQRecognizer';
// import DTWRecognizer from '../js/DTWRecognizer';
...
const recognizer = new DollarOneRecognizer();
...
useEffect(()=>{
fetch("/gesture-nav.yaml").then((r)=>r.text()).then((text)=>{
navConfigRef.current = yaml.load(text)
}).catch(() => {
        navConfigRef.current = {
          score_threshold: 0.70,
          gestures: [
            { gesture: "circle",   route: "/page1",          label: "page1"       },
            { gesture: "triangle", route: "/page2",  label: "page2"   },
            { gesture: "check",    route: "/page3",label: "page3" },
            { gesture: "caret",    route: "/page4",   label: "page4"    },
            { gesture: "arrow",    route: "/",    label: "Home"     },
            { gesture: "pigtail",  route: "/page5",     label: "page5"      },
          ],
        };
      })
},[]);
...
return (
    ...
    style={{display:"none",position:"fixed",inset:0,zIndex:9998,cursor:"crosshair",touchAction:"none"
    }}
